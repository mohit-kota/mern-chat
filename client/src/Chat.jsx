  ...
  function handleMessage(e) {
    ...
    if ("online" in messageData) {
      ...
      if ( selectedUserId  && (messageData.sender === selectedUserId)) {
        ...
        console.log("test when id not match");
      }
    }
  }
  useEffect(() => {
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col">
        ...
        <div className="flex items-center p-2 text-center justify-center">
          <span className="mr-2 items-center flex text-sm tex-gray-400">
            <svg
          ...
          <button
            onClick={logout}
            className=" border rounded-sm text-sm text-gray-500 bg-blue-100 py-1 px-2 "
          >
            logout
          </button>
        </div>
        ...
        {!!selectedUserId && (
          <form className="flex gap-2" onSubmit={sendMessage}>
            <input
              ...
              className="bg-white flex-grow border p-2 rounded-2xl"
            />
            <label className="cursor-pointer bg-blue-200 p-2 text-gray-600 rounded-sm border border-blue-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
